<?php define ('TITLE', 'International Student Housing Delft | Apartments | Paulus Buijsstraat | Room II');  ?>
<?php 
...
<div class="container">
	...
	<div class="row content">
		...
		<div class="col-md-7">
			...
			<p>Room II is around 9 square meter and situated at the front of the apartment</p>
		...
		<div class="col-md-3">
			<div class="sidebar">
				<div class="interactive-map-paulus">
					...
					<div class="inham"></div>
					<div class="hov room2 active"><p>Room 2</p><a href="paulus-buijsstraat-room2.php"></a></div>
				...
				<ol class="carousel-indicators">
				 ...
				 <div class="carousel-inner" role="listbox">
				    <div class="item active">
					    <img src="images/paulusbuys/room_2.1.jpg" alt="...">
				    	<div class="carousel-caption">
				      	</div>
				    </div>
				    <div class="item">
					    <img src="images/paulusbuys/room_2.2.jpg" alt="...">
				    	<div class="carousel-caption">
				    	</div>
				    </div>
				</div>
