<?php define ('TITLE', 'International Student Housing Delft | Apartments | Paulus Buijsstraat | Room IV');  ?>
<?php 
...
<div class="container">
	...
	<div class="row content">
		...
		<div class="col-md-7">
			...
			<p>Room IV is around 16 square meter and situated at the front of the apartment</p>
		...
		<div class="col-md-3">
			<div class="sidebar">
				<div class="interactive-map-paulus">
	                ...
	                <div class="hov room4 active"><p>Room 4</p><a href="paulus-buijsstraat-room4.php"></a></div>
	                <div class="inham"></div>
				...
				<ol class="carousel-indicators">
				 ...
				 <div class="carousel-inner" role="listbox">
				    <div class="item active">
					    <img src="images/paulusbuys/room_4.2.jpg" alt="...">
				    	<div class="carousel-caption">
				        ...
				      	</div>
				    </div>
				    <div class="item">
					    <img src="images/paulusbuys/room_4.3.jpg" alt="...">
				    	<div class="carousel-caption">
				        ...
				    	</div>
				    </div>
				    <div class="item">
					    <img src="images/paulusbuys/room_4.1.jpg" alt="...">
				    	<div class="carousel-caption">
				        ...
				    	</div>
				    </div>
