<?php define ('TITLE', 'International Student Housing Delft | Apartments | van der Lelijstraat | Room III');  ?>
<?php
 ...
 <div class="container">
    ...
    <div class="row content">
        ...
        <div class="col-md-7">
    		...
    		<p>Room III is around 17 square meter and situated at the front of the apartment</p>
        ...
        <div class="col-md-3">
            <div class="sidebar">
                <div class="interactive-map-lelijstraat">
                    <div class="hov room3 active"><p>Room 3</p><a href="vanderlelijstraat-room3.php"></a></div>
