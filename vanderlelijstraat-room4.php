<?php define ('TITLE', 'International Student Housing Delft | Apartments | van der Lelijstraat | Room IV');  ?>
<?php 
...
<div class="container">
	...
	<div class="row content">
		...
		<div class="col-md-7">
			...
			<p>Room IV is around 9 square meter and situated at the front of the apartment</p>
		...
		<div class="col-md-3">
			<div class="sidebar">
				<div class="interactive-map-lelijstraat">
					...
					<div class="hov room4 active"><p>Room 4</p><a href="vanderlelijstraat-room4.php"></a></div>
