<?php define ('TITLE', 'International Student Housing Delft | Apartments | van der Lelijstraat | Room II');  ?>
<?php 
...
<div class="container">
	...
	<div class="row content">
		...
		<div class="col-md-7">
			...
			<p>Room II is around 12 square meter and situated at the front of the apartment</p>
		...
		<div class="col-md-3">
			<div class="sidebar">
				<div class="interactive-map-lelijstraat">
					...
					<div class="hov room2 active"><p>Room 2</p><a href="vanderlelijstraat-room2.php"></a></div>
